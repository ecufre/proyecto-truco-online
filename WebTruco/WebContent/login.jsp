...
<body class="text-center">
	...
	<div class="content col-lg-8">
		...
		<% } %>
		<form class="form-signin" id="idLogIn" method="post"
			action="Jugador?action=login" autocomplete="off">
			<img class="mb-4" src="assets/img/logo.png" alt="" width="320"
				height="170"> <br> <br> <input type="input"
				id="apodo" name="apodo" class="form-control" placeholder="Usuario"
